...
-- $ psql -d pmacct -f pmacct-create-table_v9.pgsql 
--
...
CREATE TABLE acct_v9 (
	...
	vlan INT NOT NULL DEFAULT 0,
        ...
        country_src CHAR(2) NOT NULL DEFAULT '--',
        country_dst CHAR(2) NOT NULL DEFAULT '--',
	...
	flows INT NOT NULL DEFAULT 0,
        ...
        CONSTRAINT acct_v9_pk PRIMARY KEY (agent_id, class_id, mac_src, mac_dst, vlan, as_src, as_dst, ip_src, ip_dst, port_src, port_dst, countr_src, country_dst, ip_proto, tos, stamp_inserted)
);
